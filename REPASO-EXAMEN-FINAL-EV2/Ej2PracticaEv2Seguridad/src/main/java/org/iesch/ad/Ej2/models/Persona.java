...
public class Persona implements UserDetails {
    ...
    public Persona(String id, String nombre, String password, String apellido, String direccion, String telefono, String dni, LocalDate fechanacimineto, List<Licencia> licencias, List<Vehiculo> vehiculos) {
        this.id = id;
        this.nombre = nombre;
